...
import star from '../assets/img/Frame.png'
			...
			<div className='footer__container'>
				<div className='footer__col footer__brand'>
					<div className='footer__logo'>
						<span className='logo-icon'><img src={star} alt="" /></span> RENTCARS
					</div>
				...
				<div className='footer__col'>
					...
					<div className='footer__socials'>
						<i className='fab fa-facebook'><img src={facebok} alt="" /></i>
						<i className='fab fa-instagram'><img src={instagram} alt="" /></i>
						<i className='fab fa-youtube'><img src={youtube} alt="" /></i>
					</div>
				</div>
			</div>
